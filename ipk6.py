...
with tab3:
    ...
    st.write('Reaksi antara asam kuat dengan basa kuat akan menghasilkan pH larutan yang bersifat netral atau pH = 7')
    ...
    if tombol:
        ...
        st.success(f"Hasil penyetaraan reaksi adalah: 2{options1} + {options2} → {hasil} + 2H2O")
